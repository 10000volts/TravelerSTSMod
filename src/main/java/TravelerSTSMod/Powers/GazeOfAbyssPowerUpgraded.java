...
public class GazeOfAbyssPowerUpgraded extends AbstractPower {
    public static final String POWER_ID = "TravelerSTSMod:GazeOfAbyssUpgraded";
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
    public static final String NAME = powerStrings.NAME;
    public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;

    public GazeOfAbyssPowerUpgraded(AbstractCreature owner) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
    ...
    public void atStartOfTurn() {
        ...
        for (AbstractMonster mo : (AbstractDungeon.getCurrRoom()).monsters.monsters) {
            addToBot(new ApplyPowerAction(mo, AbstractDungeon.player,
                    new WhisperPower(mo, AbstractDungeon.player, this.amount), this.amount,
